...
import (
	...
	userrepo "service-complaint/internal/modules/user/repository"
	complaintrepo "service-complaint/internal/modules/complaint/repository"
...
type (
	...
	RepoSQL interface {
		...
		ComplaintRepo() complaintrepo.ComplaintRepository
	}
...
func NewRepositorySQL(readDB, writeDB *gorm.DB) RepoSQL {
	...
	return &repoSQLImpl{
		...
		complaintRepo: complaintrepo.NewComplaintRepoSQL(readDB, writeDB),
	}
}
...
func (r *repoSQLImpl) ComplaintRepo() complaintrepo.ComplaintRepository {
	return r.complaintRepo
}
