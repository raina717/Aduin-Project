...
import (
	...
	notificationrepo "service-auth/internal/modules/notification/repository"
	userrepo "service-auth/internal/modules/user/repository"
...
func NewRepositorySQL(readDB, writeDB *gorm.DB) RepoSQL {
	...
	return &repoSQLImpl{
		...
		notificationRepo: notificationrepo.NewNotificationRepoSQL(readDB, writeDB),
...
func (r *repoSQLImpl) NotificationRepo() notificationrepo.NotificationRepository {
