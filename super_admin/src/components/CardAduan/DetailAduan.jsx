...
// * Icon
import { ReactComponent as CalendarIcon } from "../../assets/icon/img_materialsymbolsdaterange.svg";
import { ReactComponent as LocationIcon } from "../../assets/icon/img_mdilocation.svg";
import { ReactComponent as ZoomIcon } from "../../assets/icon/zoom_icon.svg";
                ...
                >
                  <div className="flex justify-end items-center -mt-4 -mr-4">
                    <button
                      ...
                      className="bg-white-A700 p-1.5 rounded-full"
                    >
                      <CloseIcon fill="red" />
                    </button>
                  </div>
